...
//                    );
        ...
        $subtabs['approved'] = array( 
                            ...
                            , 'title' =>  $icon . __('Approved' ,'booking') . $sufix        // Title of TAB    
                            , 'page_title' => __('Emails Settings', 'booking')  // Title of Page   
                            , 'hint' => __('Customization of email template, which is sending to Visitor after approval of booking' ,'booking')   // Hint    
                            , 'link' => ''                                      // link
                            , 'position' => ''                                  // 'left'  ||  'right'  ||  ''
                            , 'css_classes' => ''                               // CSS class(es)
...
//debuge ( wpbc_import6_email__approved__get_fields_array_for_activation() );
            ...
            <form  name="<?php echo $submit_form_name; ?>" id="<?php echo $submit_form_name; ?>" action="" method="post" autocomplete="off">
                ...
                <div class="metabox-holder">
                    ...
                    <?php 
                        ...
                        wpbc_open_meta_box_section( $submit_form_name . 'general', __('Email is sending to Visitor after Approval of booking.', 'booking')   );
...
//          ) return;
        ...
        $js_script .= "     var wpbc_email_from = jQuery('#approved_from').val();";    // from@wpbookingcalendar.com 
