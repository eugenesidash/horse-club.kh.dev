...
class WPBC_Page_SettingsFormFieldsFree extends WPBC_Page_Structure {
    ...
    public function content() {
        ...
        do_action( 'wpbc_hook_settings_page_header', 'form_field_free_settings');       // Define Notices Section and show some static messages, if needed
...
//console.log(field_type, field_name, field_value, field_label, field_required, field_active );                
                
                jQuery('.metabox_wpbc_form_field_free_generator').show();
                jQuery('.wpbc_field_generator').hide();
                jQuery('.wpbc_field_generator_' + field_type ).show();
            ...
            <tr class="wpbc_edit_field_row">
                <th colspan="2" class="wpdevelop">                    
                    <a onclick="javascript:wpbc_finish_edit_form_field ( '<?php echo $field_name; ?>', '<?php echo $field_options['type']; ?>' );" 
                       href="javascript:void(0)" 
                       style="" 
                       class="button button"><i class="menu_icon icon-1x glyphicon glyphicon-edit"></i>&nbsp;&nbsp;<?php _e( 'Edit' ,'booking'); ?></a>
                    &nbsp;&nbsp;
                    <a onclick="javascript:wpbc_hide_fields_generators();" 
                       href="javascript:void(0)" 
                       style="" 
