...
- **Import .ics feeds** via shortcodes at pages. It gives a great flexibility to import .ics feeds from different sources (like **Airbnb, Booking.com, HomeAway, TripAdvisor, VRBO, FlipKey** or any other calendar that uses .ics format) into same booking resource.
...
- Confgure custom ULRs at setting page for **export bookings to .ics feeds/files**
